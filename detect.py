...
def parse_opt():
    ...
    #parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/kadinu/broad1/others/yolov5-master/weights/cococlean/exp_deconv_cococlean_300/weights/last.pt', help='model path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/improvement/exp_yolov5s_LSSSDD_200/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'datasets/LS-SSDD/LS-SSDD/images/val/14_16_5.jpg', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / 'data/LS_SSDD.yaml', help='(optional) dataset.yaml path')

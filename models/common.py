...
class SeparableConv(nn.Module):
    def __init__(self, nin, nout, kernel_size = 3, s=1,padding = None,  g=1,act=True):
        super(SeparableConv, self).__init__()
        self.depthwise = nn.Conv2d(nin, nin, kernel_size, s,autopad(kernel_size, padding), groups=g,bias=False)

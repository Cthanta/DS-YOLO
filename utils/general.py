...
def non_max_suppression(prediction,
    ...
    time_limit = 0.4 + 0.03 * bs  # seconds to quit after
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        if time_cost > time_limit:
            LOGGER.warning(f'WARNING: NMS time limit {time_limit:.3f}s exceeded. The cost time is {time_cost:.3f}s')
